                            ...
                            <form action="{{ route('category.store') }}" method="post" role="form">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" value="{{ old('title') }}" class="form-control" id="title" placeholder="{{ trans('backend/categories.hints.title') }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="description">{{ trans('backend/categories.attributes.description') }}</label>
                                        <textarea name="description" class="form-control" id="description" rows="3" placeholder="{{ trans('backend/categories.hints.description') }}">{{ old('description') }}</textarea>
                                    </div>
                                </div>
                                <!-- /.box-body -->
