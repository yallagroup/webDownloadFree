...
<!-- Ionicons -->
<link rel="stylesheet" href="{{ asset('backend/adminlte/bower_components/Ionicons/css/ionicons.min.css') }}">
<!-- Theme style -->
...
<!-- Morris chart -->
<link rel="stylesheet" href="{{ asset('backend/adminlte/bower_components/morris.js/morris.css') }}">
<!-- jvectormap -->
<link rel="stylesheet" href="{{ asset('backend/adminlte/bower_components/jvectormap/jquery-jvectormap.css') }}">
<!-- Date Picker -->
<link rel="stylesheet" href="{{ asset('backend/adminlte/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css') }}">
<!-- Daterange picker -->
